...
public class TwentyQuestionsWellActuallyJustTwo {
	public static void main ( String[] args ) {
		...
		if ( breadbox != null ) { //Null if the user cancels
	...
	static void showCancelMessage() {
		JOptionPane.showMessageDialog ( null, "Didn't want to play? Your loss. I had jokes.",
		                                "Party pooper", JOptionPane.PLAIN_MESSAGE );
	}
